...
export default function AffiliatePage() {
  ...
  return (
    <div className="flex flex-col min-h-dvh overflow-x-hidden">
      ...
      {/* Header/Navigation would be in layout.tsx */}

      {/* Hero Section - Enhanced */}
      <section className="relative bg-[#0e2e2e] text-white overflow-hidden">
        <div className="absolute inset-0 bg-[#0e2e2e] z-0">
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-full h-full">
              {Array.from({ length: 6 }).map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute rounded-full bg-[#b4ff00]"
                  style={{
                    top: `${Math.random() * 100}%`,
          ...
          <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#0e2e2e]/80 to-transparent"></div>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span className="text-[#b4ff00]">Affiliate Program</span>
              </h1>
              ...
              >
                <Button className="bg-[#b4ff00] text-[#0e2e2e] hover:bg-[#a3e600] text-lg px-8 py-6 group transition-all duration-300 transform hover:scale-105">
                  Apply Now
                  <ArrowRight className="ml-2 h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
                </Button>
                <Button
                  variant="outline"
                  className="border-white text-white hover:bg-white/10 text-lg px-8 py-6 transition-all duration-300 hover:scale-105"
                >
                  Learn More
                </Button>
              </motion.div>
            ...
            >
              <div className="bg-[#0e2e2e]/50 backdrop-blur-sm rounded-xl p-6 border border-white/10 shadow-[0_0_30px_rgba(180,255,0,0.15)] relative overflow-hidden">
                <div className="absolute top-0 right-0 w-40 h-40 bg-[#b4ff00]/5 rounded-full -mr-20 -mt-20 blur-xl"></div>
                <div className="absolute bottom-0 left-0 w-40 h-40 bg-[#b4ff00]/5 rounded-full -ml-20 -mb-20 blur-xl"></div>
                <motion.div
                  className="absolute top-0 right-0 w-full h-1 bg-gradient-to-r from-transparent via-[#b4ff00]/50 to-transparent"
                  animate={{
                    x: ["-100%", "100%"],
                    opacity: [0, 1, 0],
                  }}
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <motion.div
                      className="bg-[#b4ff00] rounded-full p-2"
                      initial={{ rotate: -10 }}
                      animate={{ rotate: 0 }}
                      transition={{ duration: 0.5 }}
                    >
                ...
                <div className="space-y-4 mt-6">
                  ...
                  >
                    <CheckCircle2 className="h-5 w-5 text-[#b4ff00] mr-3" />
                  ...
                  >
                    <CheckCircle2 className="h-5 w-5 text-[#b4ff00] mr-3" />
                    <span>Real-Time Affiliate Dashboard</span>
                  </motion.div>
                  <motion.div
                    className="flex items-center"
                    initial={{ opacity: 0, x: -20 }}
                  ...
                  >
                    <CheckCircle2 className="h-5 w-5 text-[#b4ff00] mr-3" />
                    <span>Free Expert Training & Client Blueprint</span>
                  </motion.div>
                  <motion.div
                    className="flex items-center"
                    initial={{ opacity: 0, x: -20 }}
          ...
          >
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-8 md:p-10 text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#b4ff00]/10 rounded-full -mr-16 -mt-16"></div>
                <div className="absolute bottom-0 left-0 w-40 h-40 bg-[#b4ff00]/10 rounded-full -ml-20 -mb-20"></div>
              ...
              <div className="bg-[#f8f8f8] p-8 md:p-10 relative" ref={statsRef}>
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#b4ff00]/10 rounded-full -mr-12 -mt-12"></div>
      ...
      <section className="py-16 bg-gray-50 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#b4ff00]/10 rounded-full -mr-32 -mt-32"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#b4ff00]/10 rounded-full -ml-32 -mb-32"></div>
