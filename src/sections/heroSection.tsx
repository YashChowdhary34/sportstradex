...
export default function HeroSection() {
  ...
  return (
    <div className="relative min-w-full bg-[#0a2a2f]">
      <section className="relative pt-28 pb-28 px-4 container mx-auto overflow-hidden">
        {/* Grid Background */}
        <div
          ref={gridRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center relative z-10">
          ...
          >
            ...
            >
              <span className="text-[#c8f65d]">Learn</span> The Science Of
              <br />
              Sports Trading
            </motion.h1>
            ...
            >
              ...
              program and kick start your career now.
            </motion.p>
            ...
            >
              <Link
                href="/account"
                className="bg-[#c8f65d] text-[#0a2a2f] font-medium px-6 py-3 rounded-full hover:bg-[#c8f65d]/75 transition-colors duration-300 btn-hover-effect"
              >
                Claim Free
              </Link>
              <Link
                href="/tutorial"
                className="flex items-center gap-2 bg-[#0a2a2f] text-white px-6 py-3 rounded-full border border-white/20 hover:bg-[#c8f65d]/25 transition-colors duration-300 btn-hover-effect"
              >
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-8">
                ...
                >
                  <span className="text-[#c8f65d]">D</span>ream 11
                </motion.div>
                <motion.div
                  className="text-white font-semibold"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
                  <span className="text-[#c8f65d]">1X</span>bat
                </motion.div>
                <motion.div
                  className="text-white font-semibold"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
                  <span className="text-[#c8f65d]">M</span>PL
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
            ...
            <div className="relative h-[450px] md:h-[500px] lg:h-[550px] w-full">
              ...
              >
                <div className="flex flex-col">
                  <span className="text-[#c8f65d] text-3xl font-bold">80K</span>
                  <span className="text-white text-sm">New Users</span>
                  <div className="flex items-center gap-1 mt-2">
                    <span className="text-[#c8f65d]">↑</span>
