...
export default function WhyOurCourse() {
    return (
      <section className="py-10 bg-[#0a2a2f]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-white/80 text-lg">
                Our courses follow a proven step-by-step approach that builds
                your knowledge and skills progressively, ensuring you master
                every concept.
              </p>
            </MotionDiv>
            ...
            >
              ...
              <p className="text-white/80 text-lg">
                Our students have consistently turned their knowledge into
                income, with many reporting 30-50% monthly returns on their
                trading capital.
              </p>
            </MotionDiv>
          </div>
