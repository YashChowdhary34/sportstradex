...
import { Zap, Utensils, Bell, Star, HeadphonesIcon } from "lucide-react";
    ...
    <>
      ...
      <section className="bg-emerald-800 text-white py-6 px-4 md:px-8 lg:px-16 border-t border-emerald-700 relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-emerald-800 to-transparent z-10"></div>
          ...
          <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-emerald-800 to-transparent z-10"></div>
        </div>
      </section>
